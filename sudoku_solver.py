...
def construct_sudoku(board):
	...
	domains={"ABCDEFGHI"[y]+"123456789"[x]:{1,2,3,4,5,6,7,8,9} if board[y][x] == 0 else {board[y][x]} for y in range(0,9) for x in range(0,9)}
